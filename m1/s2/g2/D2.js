...
if(numb1 == 8 ){console.log("il numero è uguale a 8")}
else if( numb1 + numb2 == 8 ) {console.log("la somma è uguale a 8")}
      else if(numb1 - numb2 == 8 ) {console.log ("la sottrazione è uguale a 8")}
            else console.log("numero diverso da 8");
...
if(totalShoppingCart > 50) {console.log(totalShoppingCart * 0.8)}
else {console.log(totalShoppingCart + 10)}
}
...
*/
let num_1 = 47; 
if(num_1) {console.log(typeof num_1); }
...
let x = 37 ;
let pari = (x % 2);
if( pari > 0) {console.log("Numero Dispari")}
