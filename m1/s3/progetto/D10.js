...
/* ESERCIZIO A
  Crea una variabile chiamata "sum" e assegnaci il risultato
  della somma tra i valori 10 e 20.
*/
...
*/
 ...
 console.log ("il numero uscito è " + random);
...
const me = {
 ...
 console.log("il mio nome è " + me.name + ", il mio cognome è " + me.surname + ", la mia età è " + me.age )
...
/* ESERCIZIO E
  ...
  all'oggetto precedentemente creato un array chiamato "skills", 
...
/* ESERCIZIO G
  ...
  l'ultimo elemento dall'array "skills" contenuto nell'oggetto "me".
*/
me.skills.pop();
console.log(me);
...
function whoIsBigger (a,b){
  if(a==b){return console.log("i numeri sono uguali")}
...
/* ESERCIZIO 3
  Crea una funzione chiamata "splitMe" che riceve una stringa 
  come parametro e ritorna un'array contenente ogni parola della stringa.
...
/* ESERCIZIO 4
  ...
  e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare
  la stringa senza il primo carattere, altrimenti la deve ritornare 
  senza l'ultimo.
*/
...
deleteOne('fontalba' , false)



/* ESERCIZIO 5
  Crea una funzione chiamata "onlyLetters" che riceve 
  una stringa come parametro e la ritorna eliminando tutte
  le cifre numeriche.
...
function isThisAnEmail(stringa){
  ...
  if(stringa.match(/^[\w-.]+@([\w-]+.)+[\w-]{2,4}$/)) {return true}
else {return false}

}
console.log(isThisAnEmail("luigiguajana@gmail.com"))
...
function whatDayIsIt(){
  let oggi = new Date ();
return(oggi.getDay(oggi))
}
whatDayIsIt();


/* ESERCIZIO 8
  Scrivi una funzione chiamata "rollTheDices" che riceve un
  numero come parametro. Deve invocare la precedente funzione
  dice() il numero di volte specificato nel parametro,
  e deve tornare un oggetto contenente una proprietà "sum":
    il suo valore deve rappresentare il totale di tutti i valori 
    estratti con le invocazioni di dice().
  L'oggetto ritornato deve anche contenere una proprietà "values", 
  contenente un array con tutti i valori estratti dalle invocazioni 
  di dice().
...
function rollTheDices(numero){
  ...
  tot.sum=tot.value.reduce((temp,numero)=>temp + numero,0);
  return tot;
}
...
/* ESERCIZIO 9
  Scrivi una funzione chiamata "howManyDays" che riceve una data 
  come parametro e ritorna il numero di giorni trascorsi
da tale data.
*/ 

// LA DATA INSERITA mese/giorno/anno
function howManyDays(data) {
  const oggi= new Date().getTime();
const passata = new Date(data).getTime();
const diffmill= oggi-passata;
const tempogg= Math.floor(diffmill/(1000*3600*24));
return tempogg;
}
console.log(howManyDays("12/10/2023"))
...
if (oggi == compleanno) {return ("true")}
else {return ("false")}
}
isTodayMyBirthday("9/2/2024")
...
/* ESERCIZIO 11
  Scrivi una funzione chiamata "deleteProp" che riceve
  un oggetto
  e una stringa come parametri; deve ritornare l'oggetto 
  fornito
  dopo aver eliminato in esso la proprietà chiamata
  come la stringa passata come secondo parametro.
*/
const id = {name: "luigi", surname: "guajana" , stringa:30 }

function deleteProp(id,stringa){
  delete id[stringa];
  return id;
}
console.log(deleteProp(id,'stringa'))




/* ESERCIZIO 12
  Scrivi una funzione chiamata "newestMovie" che trova
  il film più recente nell'array "movies" fornito.
*/
...
/* ESERCIZIO 13
  ...
  il numero di film contenuti nell'array "movies" fornito.
*/
...
/* ESERCIZIO 14
  ...
  con solamente gli anni di uscita dei film contenuti 
...
const onlyInLastMillennium = (array) => {
  return array.filter((movie) => {
    return (parseInt(movie.Year) >=1900 && parseInt(movie.Year) <= 1999 )
  })
}
...
const sumAllTheYears = (array) => {
  return array.reduce((temp,curr) => temp + parseInt(curr.Year),0)
}
console.log(sumAllTheYears(movies))


/* ESERCIZIO 17
  Scrivi una funzione chiamata "searchByTitle" che riceve
  una stringa come parametro e ritorna i film nell'array
...
/* ESERCIZIO 18
  ...
  come parametro e ritorna un oggetto contenente due array: 
  "match" e "unmatch".
  "match" deve includere tutti i film dell'array "movies" fornito che 
  contengono la stringa fornita all'interno del proprio titolo, mentre
...
function removeIndex(numero) {
  const escluso = [...movies];
  escluso.splice(numero, 1);
  return escluso;
}
...
*/
const testoTag = function () {
  let testo = document.getElementsByTagName("td")
  testo.forEach(function(td){
...
*/
const coloresfondo = function () {
let colore = document.querySelectorAll("a")
Array.from.colore.forEach(function(a){
...
/* ESERCIZIO 27
  Crea una funzione chiamata "halfTree" che riceve un 
  numero come parametro e costruisce un mezzo albero
